...
internal static class Program
{
    private static async Task Main()
    {
        ...
        /*
        const string url = "https://blssiatkowka.ligspace.pl/index.php?mod=Teams&ac=TeamSchedule&t_id=18";

        var client = new HttpClient();
        // Niektóre serwery blokują puste User-Agent, warto dodać udawaną przeglądarkę
